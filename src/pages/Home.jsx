...
const products = [
  ...
  { id: 9, name: "Sun glasses", price: "$60", img: "https://i.pinimg.com/474x/38/7b/d2/387bd2c2866ba0d8e02d89e21fcb9e07.jpg" },
  { id: 9, name: "Swim wear", price: "$60", img: "https://i.pinimg.com/474x/c0/f2/a7/c0f2a7f38c44df49f37ab384133913f9.jpg"},
  { id: 9, name: "Ladies' bags", price: "$60", img: "https://i.pinimg.com/474x/61/41/bc/6141bc73844331f38875094b1cf6968e.jpg" },
];

function Home() {
  const carouselRef = useRef(null);
  const intervalTime = 2000; // Time in milliseconds for autoplay
    ...
    <div className="bg-accent min-h-screen py-8">
      <MantineProvider>
        ...
        <Carousel
          ...
          className="mb-8"
          loop
          ref={carouselRef} // Attach the ref to Carousel
        >
